...
//        caps.setCapability("resolution", "2560x1440");
        ...
        driver = new RemoteWebDriver(new URL("https://" + username + ":" + authkey + hub), chromeOptions);
    ...
    public void openSeeAllIntegrationLink() throws InterruptedException {
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", JenkinsImg);
        waitUntilClickable(seeAllIntegration);
        Actions action = new Actions(driver);
        action.keyDown(Keys.CONTROL).moveToElement(seeAllIntegration).click().perform();//To open on New Window
        ...
        Assert.assertEquals(chlidWindowURl, "https://www.lambdatest.com/integrations", "Both URL are not equal");
//        driver.switchTo().window(parentWindowId);
//        String mainWindowURl = driver.getCurrentUrl();
//        System.out.println("URL is " + mainWindowURl);
